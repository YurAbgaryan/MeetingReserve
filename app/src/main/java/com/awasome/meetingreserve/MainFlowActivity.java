...
public class MainFlowActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		secondTab.setText("R O O M S");

		tabLayout.getTabAt(0).setText("M Y  E V E N T S");
		...
		fab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				startActivity(new Intent(MainFlowActivity.this, EventReservation.class));
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.menu_main_flow, menu);
		return true;
	}
